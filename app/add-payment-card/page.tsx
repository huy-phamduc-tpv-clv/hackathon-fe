...
function Profile() {
  ...
  const handleExpirationChange = (value: string) => {
    ...
    if (numericValue.length >= 2 && parseInt(numericValue.slice(0, 2)) > 12) {
      return;
    }
    ...
    <>
      <Header back={handleGoBack}>
        <Button
          radius="sm"
          color="default"
          className={`text-white ${isInputted(card) ? ' bg-primary-black' : 'bg-neutral-300'}`}
      ...
      <div className="mt-[60px]">
        <Background>
          <div className="px-3 flex flex-col">
            <h3 className="pt-3 font-medium text-xl">Add Payment Card</h3>
          </div>
          ...
          <div className="px-3 pt-4  flex flex-col gap-3">
            <Input
              ...
              label={<span className="text-secondary-green">Owner Name</span>}
            ...
            <Input
              size="md"
              placeholder="Please input"
              label={<span className="text-secondary-green">Card Number</span>}
            ...
            <div className="flex gap-3">
              <Input
                size="md"
                placeholder="MM / YY"
                label={<span className="text-secondary-green">Expiration</span>}
              ...
              <Input
                size="md"
                placeholder="Please input"
                label={<span className="text-secondary-green">CVV</span>}
                value={card.cvv}
                onValueChange={(value) =>
                  setCard((preState) => ({
                    ...preState,
