			...
			>
				<Background>
					<div className='px-3 flex flex-col'>
						<h3 className='pt-3 font-medium text-xl'>7 - 7</h3>
					</div>
					<div>
					...
					<div className='mt-5 flex justify-center relative'>
						...
						<div className='absolute top-[200px] left-[30%]'>
							<Position content='RD' />
						</div>
						<div className='absolute top-[200px] right-[30%]'>
							<Position content='LD' />
						</div>
						...
						<div className='absolute bottom-[200px] transform -translate-y-1/2'>
							<Position content='ST' />
						</div>
					</div>
