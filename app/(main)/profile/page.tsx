			...
			<Background>
				...
				<div className='px-3 pt-4  flex flex-col gap-3'>
					<Input
						...
						label={
							<span className='text-secondary-green'>Name</span>
						}
						isRequired
					/>
					<Input
						...
						placeholder='Please input'
						label={
							<span className='text-secondary-green'>Age</span>
						}
						isRequired
					/>
					<Input
						...
						placeholder='Please input'
						label={
							<span className='text-secondary-green'>Phone</span>
						}
						isRequired
					/>
					<Input
						...
						placeholder='Please input'
						label={
							<span className='text-secondary-green'>Email</span>
						}
					/>
				</div>
